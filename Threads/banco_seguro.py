...
"""
Toda vez em que precisarmos trabalhar com os dados de determinado objeto que são compartilhados entre as threds
é necessário executar um lock.
"""
